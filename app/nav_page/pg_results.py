    ...
    def draw(self):
        st.markdown(
            ...
            <div style="margin-bottom: 20px;">
                <h1 style="font-size:48px; margin-bottom:6px;">📊 Results</h1>
                <p style="font-size:18px; opacity:0.75;">
                    Results capture the outputs of crew executions. Each result represents a
                    completed run, including the inputs used, task-level outputs, and the
        ...
        st.markdown(
            ...
            ">
                ...
                <ul style="margin-top:8px; padding-left:18px; opacity:0.9;">
                    <li>Review past crew executions</li>
                    <li>Inspect inputs, task-level outputs, and final results</li>
                    <li>Compare runs across crews and dates</li>
                    <li>Export results using printable views</li>
                </ul>
            </div>
            """,
            unsafe_allow_html=True,
